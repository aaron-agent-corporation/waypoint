...
describe('@waypoint/core discussion/auto-response-contract', () => {
  ...
  it('exposes a stable auto-response request payload shape', () => {
    const payload: WaypointDiscussionAutoResponseRequestPayload = {
      ...
      task_id: 123,
      project_id: 42,
      conversation_id: 'task:123:discussion:runner-doc-drafter',
      agent: 'runner-doc-drafter',
    ...
    expect(payload.conversation_id).toBe('task:123:discussion:runner-doc-drafter')
