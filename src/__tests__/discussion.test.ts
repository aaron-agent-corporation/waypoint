...
describe('runner-core contract: discussion auto-response gating', () => {
...
describe('runner-core contract: discussion env flag parser', () => {
...
describe('runner-core contract: discussion metadata helpers', () => {
  ...
  it('detects discussion enabled flag in nested metadata', () => {
    expect(isWaypointTaskDiscussionEnabled({ runner: { discussion: { enabled: true } } })).toBe(true)
