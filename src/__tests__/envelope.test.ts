...
import { makeErrorEnvelope } from '../envelope/error-envelope.ts'
import { normalizeValidationDetails } from '../envelope/validation-details.ts'

describe('runner-core contract: envelope', () => {
