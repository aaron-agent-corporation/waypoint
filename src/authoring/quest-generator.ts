...
import type { AuthoringManifestDraftValidation } from './recipe-generator'
import { isSafeRelativePath, isSafeSlug, validateCommonDraftInput } from './recipe-generator'
      ...
      workstreams: [
        {
          ...
          name: input.domain === 'firmvault' ? 'FirmVault Draft' : `${input.name} Draft`,
          milestones: [
            {
              version_label: 'draft',
