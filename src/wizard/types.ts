export const WIZARD_DOMAINS = ['documents'] as const
...
export interface WizardAmbiguity {
  id: string
...
export interface WizardOrganizeDomainBoundary {
...
export interface WizardOrganizedDocumentEntry {
  ...
  domain_boundary: WizardOrganizeDomainBoundary
}
