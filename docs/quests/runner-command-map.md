...
Generated from `docs/quests/runner-command-map.yaml`. The YAML file is the machine-readable inventory; this markdown file is the operator-readable view.

This map translates the old get-shit-done-cc command surface into Waypoint artifacts. It does not claim that the old source CLI exists inside this repo. Commands become one of: the main `quests/runner.yaml` Quest, standalone Quest manifests, Recipe-backed catalog entries, Waypoint operator actions, or deferred optional namespace work.
...
- `commands/gsd/help.md` → `/runner help`
...
- `commands/gsd/discuss-phase.md`
  ...
  - Target: `quests/runner.yaml metadata`
  - Status: ported
