...
Add one executable smoke that proves the Spine OpenSwarm-pattern surfaces work together after WPO1-WPO9:
...
Patch paralegal skill `firmvault-runner-case-operations` to include the WPO operator/tool/handoff/authoring commands and the new smoke command.
