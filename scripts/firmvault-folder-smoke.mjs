...
try {
  ...
  assertIncludes(initCaseOutput, 'landmarks satisfied: 0/77', 'waypoint firmvault init-case')
  ...
  if (landmarkCount !== 77) throw new Error(`Expected 77 FirmVault landmarks, got ${landmarkCount}`)
