...
try {
  ...
  assertIncludes(initCaseOutput, 'landmarks satisfied: 0/57', 'waypoint firmvault init-case')
  ...
  if (landmarkCount !== 57) throw new Error(`Expected 57 FirmVault landmarks, got ${landmarkCount}`)
