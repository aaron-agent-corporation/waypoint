...
try {
  ...
  assertIncludes(initCaseOutput, 'landmarks satisfied: 0/8', 'waypoint firmvault init-case')
  ...
  if (landmarkCount !== 8) throw new Error(`Expected 8 FirmVault landmarks, got ${landmarkCount}`)
